...
pub mod result {
    /* T */
    pub use self::Which::{Error, Value};
        ...
        T: for<'c> ::capnp::traits::Owned<'c>,
    {
        ...
        pub fn set_error(
            &mut self,
            value: crate::schema::error_capnp::error::Reader<'_>,
        ) -> ::capnp::Result<()> {
    ...
    pub type WhichReader<'a, T> = Which<
        ...
        ::capnp::Result<crate::schema::error_capnp::error::Reader<'a>>,
    >;
    pub type WhichBuilder<'a, T> = Which<
        ::capnp::Result<<T as ::capnp::traits::Owned<'a>>::Builder>,
        ::capnp::Result<crate::schema::error_capnp::error::Builder<'a>>,
    >;
}
