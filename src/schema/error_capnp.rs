...
pub mod result {
        ...
        T: for<'c> ::capnp::traits::Owned<'c>,
    {
        ...
        pub fn set_error(
            &mut self,
            value: crate::error_capnp::error::Reader<'_>,
        ) -> ::capnp::Result<()> {
        ...
        #[inline]
        pub fn init_error(self) -> crate::error_capnp::error::Builder<'a> {
            self.builder.set_data_field::<u16>(0, 1);
    ...
    pub type WhichReader<'a, T> = Which<
        ...
        ::capnp::Result<crate::error_capnp::error::Reader<'a>>,
    >;
    pub type WhichBuilder<'a, T> = Which<
        ::capnp::Result<<T as ::capnp::traits::Owned<'a>>::Builder>,
        ::capnp::Result<crate::error_capnp::error::Builder<'a>>,
    >;
}
