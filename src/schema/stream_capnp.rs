...
// DO NOT EDIT.
// source: schema/stream.capnp



pub mod stream {
  #![allow(unused_variables)]
  pub type IdParams<> = ::capnp::capability::Params<crate::schema::stream_capnp::stream::id_params::Owned>;
  pub type IdResults<> = ::capnp::capability::Results<crate::schema::stream_capnp::stream::id_results::Owned>;
  ...
  impl  Client {
    pub fn id_request(&self) -> ::capnp::capability::Request<crate::schema::stream_capnp::stream::id_params::Owned,crate::schema::stream_capnp::stream::id_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, None)
    }
  }
  pub trait Server<>   {
    fn id(&mut self, _: IdParams<>, _: IdResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method stream::Server::id not implemented".to_string())) }
  }
