...
pub mod stream {
    ...
    pub type IdParams =
        ::capnp::capability::Params<crate::schema::stream_capnp::stream::id_params::Owned>;
    pub type IdResults =
        ::capnp::capability::Results<crate::schema::stream_capnp::stream::id_results::Owned>;
    ...
    impl Client {
        pub fn id_request(
            ...
            crate::schema::stream_capnp::stream::id_params::Owned,
            crate::schema::stream_capnp::stream::id_results::Owned,
        > {
