...
pub mod screen {
    ...
    pub type OpenParams =
        ::capnp::capability::Params<crate::schema::screen_capnp::screen::open_params::Owned>;
    pub type OpenResults =
        ::capnp::capability::Results<crate::schema::screen_capnp::screen::open_results::Owned>;
    ...
    impl Client {
        pub fn open_request(
            ...
            crate::schema::screen_capnp::screen::open_params::Owned,
            crate::schema::screen_capnp::screen::open_results::Owned,
        > {
    ...
    pub trait Server {
        fn open(
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method screen::Server::open not implemented".to_string(),
            ))
        }
    }
    ...
    pub mod open_results {
        ...
        impl<'a> Reader<'a> {
            ...
            pub fn get_stream_id(
                ...
                crate::schema::error_capnp::result::Reader<
                    'a,
                    crate::schema::stream_capnp::stream::Owned,
                >,
            > {
        ...
        impl<'a> Builder<'a> {
            ...
            pub fn get_stream_id(
                ...
                crate::schema::error_capnp::result::Builder<
                    'a,
                    crate::schema::stream_capnp::stream::Owned,
                >,
            > {
            ...
            pub fn set_stream_id(
                &mut self,
                value: crate::schema::error_capnp::result::Reader<
                    '_,
                    crate::schema::stream_capnp::stream::Owned,
                >,
            ) -> ::capnp::Result<()> {
        ...
        impl Pipeline {
            pub fn get_stream_id(
                &self,
            ) -> crate::schema::error_capnp::result::Pipeline<
                crate::schema::stream_capnp::stream::Owned,
            > {
