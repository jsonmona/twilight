...
pub mod host {
  ...
  pub type ListScreenParams<> = ::capnp::capability::Params<crate::schema::host_capnp::host::list_screen_params::Owned>;
  pub type ListScreenResults<> = ::capnp::capability::Results<crate::schema::host_capnp::host::list_screen_results::Owned>;
  ...
  impl  Client {
    pub fn list_screen_request(&self) -> ::capnp::capability::Request<crate::schema::host_capnp::host::list_screen_params::Owned,crate::schema::host_capnp::host::list_screen_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, None)
    }
  }
  pub trait Server<>   {
    fn list_screen(&mut self, _: ListScreenParams<>, _: ListScreenResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method host::Server::list_screen not implemented".to_string())) }
  }
  ...
  impl <_T :Server> ServerDispatch<_T> {
    pub fn dispatch_call_internal(server: &mut _T, method_id: u16, params: ::capnp::capability::Params<::capnp::any_pointer::Owned>, results: ::capnp::capability::Results<::capnp::any_pointer::Owned>) -> ::capnp::capability::Promise<(), ::capnp::Error> {
      match method_id {
        0 => server.list_screen(::capnp::private::capability::internal_get_typed_params(params), ::capnp::private::capability::internal_get_typed_results(results)),
        _ => { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("Method not implemented.".to_string())) }
      }
    }
  }
  ...
  pub mod list_screen_results {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_displays(self) -> ::capnp::Result<::capnp::capability_list::Reader<'a,crate::schema::screen_capnp::screen::Client>> {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_displays(self) -> ::capnp::Result<::capnp::capability_list::Builder<'a,crate::schema::screen_capnp::screen::Client>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_displays(&mut self, value: ::capnp::capability_list::Reader<'a,crate::schema::screen_capnp::screen::Client>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
      }
      #[inline]
      pub fn init_displays(self, size: u32) -> ::capnp::capability_list::Builder<'a,crate::schema::screen_capnp::screen::Client> {
